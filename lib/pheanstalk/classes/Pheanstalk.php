...
class Pheanstalk
{
	 ...
	 * @chainable
	 */
	public function ignore($jobid, $ahead_time, $type = 0)
	{
		return $this->_dispatch(new Pheanstalk_Command_IgnoreCommand($jobid, $ahead_time, $type));
	}
	 ...
	 */
	public function kick($jobid, $delay_time)
	{
		return $this->_dispatch(new Pheanstalk_Command_KickCommand($jobid, $delay_time));
	}
